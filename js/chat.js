...
(function () {
  ...
  const MENSAGENS_INICIAIS = [
    {
      de: 'bot',
      texto: 'Olá! Sou o assistente virtual da <strong>Bicalho & Partners</strong>. 👋',
    },
    {
      de: 'bot',
      texto: 'Posso te ajudar com dúvidas sobre <strong>abertura de empresa</strong>, <strong>contabilidade</strong>, <strong>planejamento tributário</strong>, <strong>MEI</strong> e muito mais.',
    },
    {
      de: 'bot',
  ...
  function mostrarDigitando() {
    ...
    div.innerHTML = '<div class="bp-msg-balao"><span></span><span></span><span></span></div>';
    msgsEl.appendChild(div);
    rolarParaBaixo();
  }
  ...
  async function enviarMensagem(texto) {
    ...
    try {
      ...
      removerDigitando();
      adicionarMensagem('Ops! Houve um problema de conexão. Tente novamente ou fale pelo <a href="https://wa.me/5531972599204" target="_blank">WhatsApp</a>.', 'bot');
    } finally {
